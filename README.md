...
- **Budget Tracker** (budget.py) - menu-driven expense tracker with add expense, view all expenses, view total spent, and view spending broken down by category, and delete an expense, with expenses saved to a file so they persist between runs